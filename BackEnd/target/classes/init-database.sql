...
-- InnoDB相关参数
('MySQL (v9.5.0)', 'bulk_insert_buffer_size', 'Integer', 'MyISAM表批量插入缓冲区大小', '8388608', '0-20971520', 5.0, true),
('MySQL (v9.5.0)', 'innodb_adaptive_hash_index', 'Boolean', 'InnoDB自适应哈希索引', 'ON', 'OFF,ON', 5.0, true),
('MySQL (v9.5.0)', 'innodb_change_buffering', 'Enumeration', 'InnoDB变更缓冲', 'all', 'none,all', 5.0, true),
('MySQL (v9.5.0)', 'innodb_cmp_per_index_enabled', 'Boolean', 'InnoDB每索引压缩统计', 'OFF', 'ON,OFF', 5.0, true),
('MySQL (v9.5.0)', 'innodb_ddl_threads', 'Integer', 'InnoDB DDL线程数', '4', '1-4', 5.0, true),
('MySQL (v9.5.0)', 'innodb_file_per_table', 'Boolean', 'InnoDB每表一个文件', 'ON', 'OFF,ON', 5.0, true),
('MySQL (v9.5.0)', 'innodb_flush_neighbors', 'Enumeration', 'InnoDB刷新邻居页面', '1', '1,2', 5.0, true),
('MySQL (v9.5.0)', 'innodb_max_dirty_pages_pct', 'Numeric', 'InnoDB最大脏页百分比', '90', '0-99.99', 5.0, true),
('MySQL (v9.5.0)', 'innodb_max_dirty_pages_pct_lwm', 'Numeric', 'InnoDB脏页低水位标记', '10', '0-99.99', 5.0, true),
('MySQL (v9.5.0)', 'innodb_random_read_ahead', 'Boolean', 'InnoDB随机预读', 'OFF', 'ON,OFF', 5.0, true),
('MySQL (v9.5.0)', 'innodb_read_ahead_threshold', 'Integer', 'InnoDB预读阈值', '56', '0-64', 5.0, true),
('MySQL (v9.5.0)', 'innodb_stats_auto_recalc', 'Boolean', 'InnoDB统计自动重算', 'ON', 'OFF,ON', 5.0, true),
('MySQL (v9.5.0)', 'innodb_stats_method', 'Enumeration', 'InnoDB统计方法', 'nulls_equal', 'nulls_unequal,nulls_ignored,nulls_equal', 5.0, true),
('MySQL (v9.5.0)', 'innodb_stats_persistent_sample_pages', 'Integer', 'InnoDB持久化统计采样页数', '20', '1-1000', 5.0, true),
('MySQL (v9.5.0)', 'innodb_use_fdatasync', 'Boolean', 'InnoDB使用fdatasync', 'OFF', 'ON,OFF', 5.0, true),

-- 连接和并发参数
('MySQL (v9.5.0)', 'concurrent_insert', 'Enumeration', '并发插入模式', '1', '0,1,2', 5.0, true),
('MySQL (v9.5.0)', 'foreign_key_checks', 'Boolean', '外键检查', '1', '0,1', 5.0, true),

-- 存储引擎参数
('MySQL (v9.5.0)', 'default_storage_engine', 'Enumeration', '默认存储引擎', 'InnoDB', 'MyISAM,InnoDB', 5.0, true),
('MySQL (v9.5.0)', 'delay_key_write', 'Enumeration', '延迟键写入', 'ON', 'OFF,ALL', 5.0, true),

-- 查询优化参数
('MySQL (v9.5.0)', 'eq_range_index_dive_limit', 'Integer', '等值范围索引深入限制', '200', '0-4294967295', 5.0, true),
('MySQL (v9.5.0)', 'group_concat_max_len', 'Integer', 'GROUP_CONCAT最大长度', '1024', '4-18446744073709551615', 5.0, true),
('MySQL (v9.5.0)', 'optimizer_prune_level', 'Integer', '优化器修剪级别', '1', '0,1', 5.0, true),
('MySQL (v9.5.0)', 'optimizer_search_depth', 'Integer', '优化器搜索深度', '62', '0-62', 5.0, true),
('MySQL (v9.5.0)', 'optimizer_switch', 'Set', '优化器开关', 'index_merge=on,index_merge_union=on', '', 5.0, false),

-- 缓冲区参数
('MySQL (v9.5.0)', 'join_buffer_size', 'Integer', '连接缓冲区大小', '262144', '128-4294967295', 5.0, true),
('MySQL (v9.5.0)', 'key_buffer_size', 'Integer', '键缓冲区大小', '8388608', '4096-4294967295', 5.0, true),
('MySQL (v9.5.0)', 'read_buffer_size', 'Integer', '读缓冲区大小', '131072', '8192-2147483647', 5.0, true),
('MySQL (v9.5.0)', 'read_rnd_buffer_size', 'Integer', '随机读缓冲区大小', '262144', '1-2147483647', 5.0, true),
('MySQL (v9.5.0)', 'sort_buffer_size', 'Integer', '排序缓冲区大小', '262144', '32768-4294967295', 5.0, true),
('MySQL (v9.5.0)', 'preload_buffer_size', 'Integer', '预加载缓冲区大小', '32768', '1024-1073741824', 5.0, true),
('MySQL (v9.5.0)', 'query_alloc_block_size', 'Integer', '查询分配块大小', '8192', '1024-4294967295', 5.0, true),

-- MyISAM参数
('MySQL (v9.5.0)', 'myisam_data_pointer_size', 'Integer', 'MyISAM数据指针大小', '6', '2-7', 5.0, true),
('MySQL (v9.5.0)', 'myisam_max_sort_file_size', 'Integer', 'MyISAM最大排序文件大小', '9223372036853727232', '0-9223372036853727232', 5.0, true),
('MySQL (v9.5.0)', 'myisam_sort_buffer_size', 'Integer', 'MyISAM排序缓冲区大小', '8388608', '4096-4294967295', 5.0, true),
('MySQL (v9.5.0)', 'myisam_stats_method', 'Enumeration', 'MyISAM统计方法', 'nulls_unequal', 'nulls_equal,nulls_ignored,nulls_unequal', 5.0, true),
('MySQL (v9.5.0)', 'myisam_use_mmap', 'Boolean', 'MyISAM使用内存映射', 'OFF', 'ON,OFF', 5.0, true),

-- 系统参数
('MySQL (v9.5.0)', 'low_priority_updates', 'Boolean', '低优先级更新', 'OFF', 'ON,OFF', 5.0, true),
('MySQL (v9.5.0)', 'max_seeks_for_key', 'Integer', '键的最大查找次数', '4294967295', '1-4294967295', 5.0, true),
('MySQL (v9.5.0)', 'max_sort_length', 'Integer', '最大排序长度', '1024', '4-8388608', 5.0, true),
('MySQL (v9.5.0)', 'max_sp_recursion_depth', 'Integer', '存储过程最大递归深度', '0', '0-255', 5.0, true),
('MySQL (v9.5.0)', 'range_optimizer_max_mem_size', 'Integer', '范围优化器最大内存大小', '8388608', '0-18446744073709551615', 5.0, true),
('MySQL (v9.5.0)', 'read_only', 'Boolean', '只读模式', 'OFF', 'ON,OFF', 5.0, true),
('MySQL (v9.5.0)', 'regexp_stack_limit', 'Integer', '正则表达式栈限制', '8000000', '0-2147483647', 5.0, true),
('MySQL (v9.5.0)', 'rewriter_enabled', 'Boolean', '查询重写器启用', 'OFF', 'ON,OFF', 5.0, false),
('MySQL (v9.5.0)', 'table_open_cache', 'Integer', '表打开缓存', '4000', '1-524288', 5.0, true),

-- SQL模式参数
('MySQL (v9.5.0)', 'sql_auto_is_null', 'Boolean', 'SQL自动IS NULL', 'OFF', 'ON,OFF', 5.0, true),
('MySQL (v9.5.0)', 'sql_big_selects', 'Boolean', 'SQL大查询', 'ON', 'ON,OFF', 5.0, true),
('MySQL (v9.5.0)', 'sql_buffer_result', 'Boolean', 'SQL缓冲结果', 'OFF', 'ON,OFF', 5.0, true),
('MySQL (v9.5.0)', 'sql_generate_invisible_primary_key', 'Boolean', 'SQL生成不可见主键', 'OFF', 'ON,OFF', 5.0, true),
('MySQL (v9.5.0)', 'sql_mode', 'Set', 'SQL模式', 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION', 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION', 5.0, false);
